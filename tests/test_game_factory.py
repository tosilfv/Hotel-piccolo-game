...
class TestGameFactory:
    ...
    def test_create_game_with_mocks(self, mock_screen, mock_background, mock_player, mock_mediator, mock_input):
        """Test create_game with mocks"""
        # Define what patch returns
        ...
        mock_player.assert_called_once_with(self.screen_instance)
        mock_mediator.assert_called_once_with(self.background_instance, self.player_instance)
